...
describe('Create Site Tool', () => {
  ...
  const companies = [
    { gpid: 'TI DEVTES174', name: 'Dev Test 20231109' }
  ];
  ...
  companies.forEach(company => {
    it(`Search and verify ${company.gpid}`, () => {
      ...
      cy.visit('https://dms.townsquareinteractive.com/tsi/admin/portal/client-search-v2?ff=pin:createSiteUpdate:1');

      cy.visit('https://dms.townsquareinteractive.com/tsi/admin/portal/client-search-v2');
